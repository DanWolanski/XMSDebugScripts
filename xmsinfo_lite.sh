...
OUTFILE=`hostname`-xmsinfo_lite-$starttime.tgz
...
echo "----------------------------------------------------------------------------" >> /var/log/xms/additionalinfo.out
echo "top -b -n 5" >> /var/log/xms/additionalinfo.out
echo "----------------------------------------------------------------------------" >> /var/log/xms/additionalinfo.out
top -b -n 5 >> /var/log/xms/additionalinfo.out
echo "----------------------------------------------------------------------------" >> /var/log/xms/additionalinfo.out
echo "top -H -b -n 5  (threads)" >> /var/log/xms/additionalinfo.out
echo "----------------------------------------------------------------------------" >> /var/log/xms/additionalinfo.out
top -H -b -n 5 >> /var/log/xms/additionalinfo.out
echo "----------------------------------------------------------------------------" >> /var/log/xms/additionalinfo.out
echo "----------------------------------------------------------------------------" >> /var/log/xms/additionalinfo.out
...
ls -altr /var/cache/xms/http/xmserver/ >> /var/log/xms/mediafileinfo.out
echo "----------------------------------------------------------------------------" >> /var/log/xms/mediafileinfo.out
echo Media Files >> /var/log/xms/mediafileinfo.out
echo "----------------------------------------------------------------------------" >> /var/log/xms/mediafileinfo.out
find /var/lib/xms/media -type f -name '*' -exec ls -altr {} \; >> /var/log/xms/mediafileinfo.out
echo "----------------------------------------------------------------------------" >> /var/log/xms/mediafileinfo.out
echo Old/Stuck Files >> /var/log/xms/mediafileinfo.out
echo "----------------------------------------------------------------------------" >> /var/log/xms/mediafileinfo.out
find /var/lib/xms/media -type f -name '*' -mmin +30 -exec ls -altr {} \; >> /var/log/xms/mediafileinfo.out
echo "----------------------------------------------------------------------------" >> /var/log/xms/mediafileinfo.out
echo Small Files >> /var/log/xms/mediafileinfo.out
echo "----------------------------------------------------------------------------" >> /var/log/xms/mediafileinfo.out
find /var/lib/xms/media -type f -size -16c -name '*.amr' -printf "%p  - %c - %k KB\n"  >> /var/log/xms/webuiinfo.out
find /var/lib/xms/media -type f -size -16c -name '*.wav' -printf "%p  - %c - %k KB\n"  >> /var/log/xms/webuiinfo.out
echo "----------------------------------------------------------------------------" >> /var/log/xms/mediafileinfo.out
echo Buffered Repository >> /var/log/xms/mediafileinfo.out
echo "----------------------------------------------------------------------------" >> /var/log/xms/mediafileinfo.out
find /root/buffered_messages -type f -name '*' -mmin +30 -exec ls -altr {} \; >> /var/log/xms/mediafileinfo.out
#echo "----------------------------------------------------------------------------" >> /var/log/xms/mediafileinfo.out
#echo All Files >> /var/log/xms/mediafileinfo.out
#echo "----------------------------------------------------------------------------" >> /var/log/xms/mediafileinfo.out
#find / -type f -name '*.amr' -exec ls -altr {} \;  >> /var/log/xms/mediafileinfo.out


tar cvzf $OUTFILE --exclude='*.tgz' --exclude='*.tar.gz' --exclude='*.sh'  /var/log/xms/*.out /var/log/messages* /etc/profile.d/ct_intel.sh /boot/grub/menu.lst /etc/xms /usr/dialogic/cfg /etc/hosts /var/lib/xms/meters/currentValue.txt /var/lib/xms/meters/rrd/*
